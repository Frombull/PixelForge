export class InspectorPanel {
    ...
    setupCollapsibles() {
        ...
        transformHeader?.addEventListener('click', () => {
            const collapsed = transformContent.classList.contains('collapsed');
            transformContent.classList.toggle('collapsed', !collapsed);
            transformHeader.classList.toggle('open', collapsed);
        });
        ...
        materialHeader?.addEventListener('click', () => {
            const collapsed = materialContent.classList.contains('collapsed');
            materialContent.classList.toggle('collapsed', !collapsed);
            materialHeader.classList.toggle('open', collapsed);
        });
    }
